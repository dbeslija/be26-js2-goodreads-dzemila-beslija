Enkel websida där du kan hantera din boklista. 

För användaren:

*Se dina böcker och dess författare
*Markera en bok som läst
*Betygsätt lästa böcker mellan 1 och 5
*Ta bort böcker
*Lägg till böcker genom att ange titel och författare
